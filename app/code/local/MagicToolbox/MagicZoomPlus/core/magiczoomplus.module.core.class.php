...
if(!defined('MagicZoomPlusModuleCoreClassLoaded')) {
    ...
    class MagicZoomPlusModuleCoreClass {
        ...
        function getHeadersTemplate($jsPath = '', $cssPath = null) {
            ...
            $headers = array();
            $headers[] = '<!-- Magic Zoom Plus Magento module version v4.15.0 [v1.6.65:v5.2.4] -->';
        ...
        function loadDefaults() {
            $params = array(
				...
				"selectorTrigger"=>array("id"=>"selectorTrigger","advanced"=>"1","group"=>"Multiple images","order"=>"10","default"=>"click","label"=>"Swap trigger","description"=>"Mouse event used to swtich between multiple images.","type"=>"array","subType"=>"radio","values"=>array("click","hover"),"scope"=>"magiczoomplus","desktop-only"=>""),
